...
const nameForSummary = getLongInput('@@Name: The name of the button that will contain the Microsoft Visio@@', 'Name: The name of the button that will contain the Microsoft Visio', opts);
const dURL = getLongInput('@@Microsoft Visio URL@@', "Microsoft Visio URL", opts);
/* 
...
function onLoad(url){
      if (typeof(url) != 'undefined') {
            const embedURL = URLtoEmbedURL(url);
...
function setBackgrounColor(backGroundColor) {
      if (backGroundColor == 'rgb(255, 255, 255)') {
            if (detailsButton.classList.contains('detailsCollapsibleMSVisio')) {return;}
            // Light mode
            detailsButton.classList.add('detailsCollapsibleMSVisio');
            detailsButton.classList.remove('detailsCollapsibleDarkModeMSVisio');
            headerLink.classList.add('HeaderLinkMSVisio');
            headerLink.classList.remove('HeaderLinkDarkModeMSVisio');
            fullscreenButton.classList.add('LinkMSVisio');
            fullscreenButton.classList.remove('LinkDarkModeMSVisio'); 
      } else if (backGroundColor == 'rgb(25, 26, 30)') {
            if (detailsButton.classList.contains('detailsCollapsibleDarkModeMSVisio')) {return;}
            // Dark mode
            detailsButton.classList.add('detailsCollapsibleDarkModeMSVisio');
            detailsButton.classList.remove('detailsCollapsibleMSVisio');
            headerLink.classList.add('HeaderLinkDarkModeMSVisio');
            headerLink.classList.remove('HeaderLinkMSVisio');
            fullscreenButton.classList.add('LinkDarkModeMSVisio');
            fullscreenButton.classList.remove('LinkMSVisio');
      }
}
