...
const nameForSummary = getLongInput('@@Name@@', "Name: The name of the button that will contain the YouTube video", opts);
const youTubeURL = getLongInput('@@YouTube URL@@', "YouTube URL: Copy in the link/URL of the video you want to embed", opts);
